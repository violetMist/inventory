  ...
  <div class="app-container">
    ...
    <div class="table-tools">    
      ...
      <div class="tools-line">
        ...
        <el-select clearable filterable v-model="listQuery.commercial" placeholder="请选择商户买家">
          <el-option
    ...
    <el-table
      ...
      <el-table-column align="center" label="出库详情编号" width="240">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="买家" width="300">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="出库时间" width="160">
        <template slot-scope="scope">
...
<script>
  ...
  import { getList } from '@/api/outStore.js'
  ...
  export default {
    ...
    methods: {
      goFn () {
        this.$router.push('/store/sellOrder')
      },
      getTime (date) {
        if (!date)
          return ''
